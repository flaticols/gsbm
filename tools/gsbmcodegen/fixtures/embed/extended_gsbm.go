...
func (v *Extended) MarshalGSBM(w *gsbm.Writer) error {
	// tag 1 Total
...
func (v *Extended) UnmarshalGSBM(r *gsbm.Reader) error {
...
func (v *Extended) Reset() {
	v.Base.Total = 0
	v.Reason = ""
	gsbm.ClearPresence(v)
}

func (v *Extended) FieldPresent(tag uint32) bool {
